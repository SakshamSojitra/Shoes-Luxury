...
export const products: Product[] = [
  ...
  { id: "28", name: "Nike Concepts x Nike Dunk Low SB 'Orange Lobster'", brand: "Nike", price: 30999, description: "A standout Concepts collaboration built with premium detailing and a bold orange finish.", sizes: allSizes, images: ["/products/nike-orange-1.png", "/products/nike-orange-2.png", "/products/nike-orange-3.png", "/products/nike-orange-4.png", "/products/nike-orange-5.png"], isLimited: false, category: "Lifestyle" },
  ...
  { id: "10", name: "Adidas Samba OG 'Collegiate Green Core Black Gum'", brand: "Adidas", price: 9999, description: "A classic Samba silhouette in collegiate green with timeless street-ready style.", sizes: allSizes, images: ["/products/adidas-samba-green-1.png", "/products/adidas-samba-green-2.png", "/products/adidas-samba-green-3.png", "/products/adidas-samba-green-4.png", "/products/adidas-samba-green-5.png"], isLimited: false, category: "Lifestyle" },
  ...
  { id: "16", name: "Adidas Handball Spezial 'Night Indigo'", brand: "Adidas", price: 10999, description: "Classic terrace style with a refined night indigo finish.", sizes: allSizes, images: ["/products/adidas-spezial-blue-white-grip-1.png"], isLimited: false, category: "Lifestyle" },
  ...
  { id: "22", name: "Adizero EVO SL Shoes", brand: "Adidas", price: 14999, description: "Speed-inspired shoes designed for fast culture.", sizes: allSizes, images: ["/products/adidas-adizero-evo-sl-black-white-1.png", "/products/adidas-adizero-evo-sl-black-white-2.png", "/products/adidas-adizero-evo-sl-black-white-3.png"], isLimited: false, category: "Lifestyle" },
...
export function getProductPrice(product: Product, size?: number): number {
  ...
  if (product.id === "10") {
    if (size >= 4 && size <= 5) return 9999;
    if (size >= 6 && size <= 10) return 10999;
    if (size >= 11 && size <= 12) return 11999;
  }
  ...
  if (product.id === "16") {
    if (size >= 4 && size <= 6) return 9999;
    if (size >= 7 && size <= 12) return 10999;
  }
  ...
  if (product.id === "21") {
   ...
   if (product.id === "22") {
    if (size >= 4 && size <= 5) return 10999;
    if (size >= 6 && size <= 12) return 14999;
  }
  ...
  if (product.id === "28") {
    if (size === 4) return 24999;
    if (size === 5) return 26999;
    if (size === 6) return 27999;
    if (size === 7) return 30999;
    if (size === 8) return 31999;
    if (size === 9) return 38999;
    if (size === 10) return 40999;
    if (size === 11) return 42999;
    if (size === 12) return 44999;
  }
